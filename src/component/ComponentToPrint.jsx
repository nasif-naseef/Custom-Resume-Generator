            ...
            <div className="resume" style={{fontFamily:this.props.fontFamily}}>
                ...
                <div className="section">
                    ...
                    <div className="right-section">
                        ...
                        {(this.props.certificate3.name === '' && this.props.certificate2.name === '' && this.props.certificate.name === '') ? null : <div className="certificates">
                            <h2 className="section-heading" style={{color: this.props.primary}}>Certificates</h2>
                            {(this.props.certificate.name === '') ? null : <div className="div" style={{ marginBottom: '1rem' }} >
                                <div style={{ display: 'flex', flexWrap: 'wrap', color: this.props.secondary}}>
                                    <h2 style={{ fontSize: '1rem', textTransform: 'capitalize' }}>{this.props.certificate.name}</h2>
                                    {
                                        this.props.certificate.link === '' ? null :
                                            <a href={this.props.certificate.link} style={{ fontSize: '1rem', fontWeight: '400' }} className="attachments">
                                                <AttachmentIcon style={{color: this.props.secondary}} />
                                            </a>

                                    }
                                </div>
                                <h5 style={{ fontWeight: '400', display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>Certified By:  <h2 className="certified-by" style={{ fontSize: '1rem', fontWeight: '400', color: this.props.secondary }}>{this.props.certificate.tech}</h2></h5>

                                <p style={{}} >- {this.props.certificate.desc}</p>
                            </div>}
                            {(this.props.certificate2.name === '') ? null : <div className="div" style={{ marginBottom: '1rem' }} >
                                <div style={{ display: 'flex', flexWrap: 'wrap', color: this.props.secondary }}>
                                    <h2 style={{ fontSize: '1rem' }}>{this.props.certificate2.name}</h2>
                                    {
                                        this.props.certificate2.link === '' ? null :
                                            <a href={this.props.certificate2.link} style={{ fontSize: '1rem', fontWeight: '400' }} className="attachments">
                                                <AttachmentIcon style={{ color: this.props.secondary }} />
                                            </a>

                                    }
                                </div>
                                <h5 style={{ fontWeight: '400', display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>Certified By:  <h2 className="certified-by" style={{ fontSize: '1rem', fontWeight: '400', color: this.props.secondary }}> {this.props.certificate2.tech}</h2></h5>

                                <p style={{}} >- {this.props.certificate2.desc}</p>
                            </div>}
                            {(this.props.certificate3.name === '') ? null : <div className="div" style={{ marginBottom: '1rem' }} >
                                <div style={{ display: 'flex', flexWrap: 'wrap',color: this.props.secondary }}>
                                    <h2 style={{ fontSize: '1rem' }}>{this.props.certificate3.name}</h2>
                                    {
                                        this.props.certificate3.link === '' ? null :
                                            <a href={this.props.certificate2.link} style={{ fontSize: '1rem', fontWeight: '400' }} className="attachments">
                                                <AttachmentIcon style={{color: this.props.secondary}} />
                                            </a>
                                ...
                                <h5 style={{ fontWeight: '400', display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>Certified By:  <h2 className="certified-by" style={{ fontSize: '1rem', fontWeight: '400', color: this.props.secondary}}>{this.props.certificate3.tech}</h2></h5>

                                <p style={{}} >- {this.props.certificate3.desc}</p>
                            </div>}
                            {(this.props.certificate4.name === '') ? null : <div className="div" style={{ marginBottom: '1rem' }} >
                                <div style={{ display: 'flex', flexWrap: 'wrap',color: this.props.secondary }}>
                                    <h2 style={{ fontSize: '1rem' }}>{this.props.certificate4.name}</h2>
                                    {
                                        this.props.certificate4.link === '' ? null :
                                            <a href={this.props.certificate4.link} style={{ fontSize: '1rem', fontWeight: '400' }} className="attachments">
                                                <AttachmentIcon style={{color: this.props.secondary}} />
                                            </a>

                                    }
                                </div>
                                <h5 style={{ fontWeight: '400', display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>Certified By:  <h2 className="certified-by" style={{ fontSize: '1rem', fontWeight: '400', color: this.props.secondary}}>{this.props.certificate4.tech}</h2></h5>

                                <p style={{}} >- {this.props.certificate4.desc}</p>
                            </div>}
                        </div>}
