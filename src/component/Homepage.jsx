...
function Homepage() {
  ...
  const isEmpty = () => {
    ...
    let certificateArray = [certificate, certificate2, certificate3, certificate4];
    for (let i = 0; i < 4; ++i) {
      if (JSON.stringify(projectArray[i]) !== JSON.stringify(dummyProject)) {
        return false;
      }
  ...
  useEffect(() => {
    ...
    setcertificate(
      localStorage.getItem("certificate") == null
        ? projectObject
        : JSON.parse(localStorage.getItem("certificate"))[0]
    );
    setcertificate2(
      localStorage.getItem("certificate") == null
        ? projectObject
        : JSON.parse(localStorage.getItem("certificate"))[1]
    );
    setcertificate3(
      localStorage.getItem("certificate") == null
        ? projectObject
        : JSON.parse(localStorage.getItem("certificate"))[2]
    );
    setcertificate4(
      localStorage.getItem("certificate") == null
        ? projectObject
        : JSON.parse(localStorage.getItem("certificate"))[3]
    );
    setexp(
  ...
  useEffect(() => {
    ...
    localStorage.setItem(
      "certificate",
      JSON.stringify([certificate, certificate2, certificate3, certificate4])
    );
    localStorage.setItem(
      "exp",
  ...
  return (
    <div id="main">
      <header className="header">
        <h2>VTTC</h2>
        <h1>
          📄<span>Custom Resume Generator </span>{" "}
        </h1>
        <div className="right">
          <a href="https://github.com/nasif-naseef/Custom-Resume-Generator">Contribute</a>
          <a href="https://github.com/nasif-naseef/Custom-Resume-Generator">
            Give us star
          </a>
        </div>
      </header>
      <main className="maincomponent">
        <div className="left">
          <div className="navbar">
            ...
            <li
              className={nav === "Certificates" ? "active" : ""}
              onClick={() => setnav("Certificates")}
            >
              Certificates
            </li>
            <li
          ...
          {nav === "Certificates" ? (
            <Certificates
              ...
              setcertificate2={setcertificate2}
              name2={certificate2.name}
              link2={certificate2.link}
              certified2={certificate2.certified}
              desc2={certificate2.desc}
              certificate3={certificate3}
              setcertificate3={setcertificate3}
              name3={certificate3.name}
              link3={certificate3.link}
              certified3={certificate3.certified}
              desc3={certificate3.desc}
              certificate4={certificate4}
              setcertificate4={certificate4}
              name4={certificate4.name}
              link4={certificate4.link}
              certified4={certificate4.certified}
              desc4={certificate4.desc}
            />
          ) : null}
          {nav === "Achievements" ? (
            <Achievements
      ...
      <footer className="footer">
        <p>Custom Resume Generaror © 2021.</p>
      </footer>
    </div>
  );
}
